...
public class QueryProcessor {
    ...
    public ArrayList<String> start(String text)
    {
    	ArrayList<String> postText = new ArrayList<String>();
    	StringTokenizer multiTokenizer = new StringTokenizer(text.toLowerCase() , " !\"#$%&'()-+,-./0123456789:;<=>?@[]^_`{|}~");
		...
		while (multiTokenizer.hasMoreTokens())
		{
			...
			{
		        porterStemmer.setCurrent(nextToken);
		        porterStemmer.stem();
		        postText.add(porterStemmer.getCurrent());
			}
			else
			{
				System.out.println("\""+nextToken+"\" is stop word");
			}
	...
	public static void main(String[] args) {		
		...
		ArrayList<String> postText=q.start("All you other Slim Shadys are just imitating");
		//To-do(Mark) Match or index them (array of words)
		for	(int i=0;i<postText.size();i++)
		{
			System.out.println(postText.get(i));
		}
